...
//  Chat Application
//
//  Created by Ivan Divljak on 5/15/18.
...
class LocationViewController: UIViewController, ARSCNViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        pinLocation = CLLocation(latitude: 45.25537840499621, longitude: 19.79440143392742)
        userLocation = CLLocation(latitude: 45.25615604, longitude: 19.79518739)
